...
# %% auto 0
__all__ = ['CONTEXT_MAX_WORDS', 'MODEL_ID', 'conversation_api', 'coding_api', 'OpenAIAPI', 'ConversationAPI', 'CodingAPI',
           'collect_code_history', 'ai_settings', 'ai_ask', 'ai_continue', 'ai_code', 'load_ipython_extension']
